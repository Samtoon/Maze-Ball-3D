...
export default class MirrorSphere {
  ...
  constructor(scene, color = 0x00FFFF, opacity = 0.5) {
  ...
  update(renderer, scene) {
    ...
    this._colorSphere.position.x = this._position.x;
    this._colorSphere.position.y = this._position.y;
    this._colorSphere.position.z = this._position.z;
